...
def test_index(mock_listdir):
  ...
  expected.addRelation('urn:X-hypercat:rels:hasHomePage', 'http://www.transportapi.com/v3/')
  ...
  expected.addItem(r1_live, 'http://transportapi.com/v3/cat/ferry/live.json')
  expected.addItem(r1_timetable, 'http://transportapi.com/v3/cat/ferry/timetable.json')
  expected.addItem(r2_live, 'http://transportapi.com/v3/cat/train/live.json')
  expected.addItem(r2_timetable, 'http://transportapi.com/v3/cat/train/timetable.json')
