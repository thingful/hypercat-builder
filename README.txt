...
## Usage
By deafult the script reads csv files located in the /data folder inside the root folder (IE where the script is located) and saves hypercat catalogues in the /output folder.
...
## Flags
The script default behaviours can be modified using optionl flags:
